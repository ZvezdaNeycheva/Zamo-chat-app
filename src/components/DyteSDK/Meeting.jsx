          ...
          <div className="flex gap-24 ml-5 text-gray-200">
            <div>
              ...
              <div className="flex items-center mt-2">
                <button className="btn btn-sm border-none bg-green-500 text-white px-4 py-2 rounded-md transition-colors duration-300 hover:bg-green-600" onClick={handleJoinMeeting}>Join Call</button>
