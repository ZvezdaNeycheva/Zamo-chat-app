...
//   // return (
//   //   <>
//   //     <div className="justify-center items-center h-screen w-4/5">
...
//   //               <img src={user?.profilePhotoURL || "https://thinksport.com.au/wp-content/uploads/2020/01/avatar-.jpg"} className="sm:w-48 sm:h-48 md:w-52 md:h-52 lg:w-56 lg:h-56 xl:w-60 xl:h-60 2xl:w-64 2xl:h-64 p-1 border border-gray-100 rounded-full dark:border-zinc-800" alt="Avatar" />
//   //             </div>
//   //           </div>
