...
import { uploadBackgroundPhoto, uploadProfileImage } from "../service/auth.service";
        ...
        <div className="flex items-center justify-center w-full h-full top-0 left-0 absolute z-50 backdrop-blur-sm bg-black/20 l:pt-40 xl:pt-0 m:pt-40">
            <div className="relative bg-white min-w-full min-h-full lg:min-w-[800px] lg:min-h-[600px] lg:rounded-lg lg:shadow-lg dark:bg-gray-800">
                ...
                <div className="bg-cover bg-center relative dark:bg-gray-800">
                    ...
                    <img src={user?.profileBackgroundURL || "https://images.pexels.com/photos/255379/pexels-photo-255379.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"} className="w-full h-80 object-cover absolute rounded-t-lg" alt="background" />
                    {/* Add Background Img */}
                    ...
                    <div className="px-6 pt-6">
                        <div className="ltr:float-right rtl:float-left">
                            <div className={`relative flex-shrink-0 dropdown `}>
                                ...
                                <ul className={`${open ? "visible" : "invisible"} absolute z-50 block w-40 text-left list-none bg-red-700 border border-transparent rounded shadow-lg rtl:right-auto rtl:left-0 ltr:left-auto ltr:right-0 my-7 bg-clip-padding dark:bg-zinc-700 dark:shadow-sm dark:border-zinc-600`} aria-labelledby="dropdownMenuButtonA">
                                    <li>
                        ...
                        <div className="relative ">
                            <p className="left-14 top-3 top-3.5 font-semibold text-center text-white absolute xl:text-4xl lg:text-3xl base:text-2xl sm:text-2xl xs:text-2xl"> My Profile </p>
                        </div>
                    </div>
                    ...
                    <div className="p-6 text-center">
                        <div className="mb-4 relative flex flex-col items-start justify-end top-24">
                            ...
                            <img src={user?.profilePhotoURL || "https://thinksport.com.au/wp-content/uploads/2020/01/avatar-.jpg"} className="sm:w-12 sm:h-12 md:w-52 md:h-52 lg:w-56 lg:h-56 xl:w-60 xl:h-60 2xl:w-64 2xl:h-64 p-1 border border-gray-100 rounded-full dark:border-zinc-800" alt="Avatar" />
                        </div>
                    </div>
                ...
                <div className="border rounded-lg p-4 bg-white dark:bg-gray-800 shadow-lg w-100 h-auto mt-20 ml-5 mr-5 mb-5">
                    ...
                    <div className="relative mb-1 flex mt-2 dark:bg-gray-800">
                        ...
                        <div className="relative ml-2 dark:bg-gray-800">
                            <button onClick={() => toggleDropdown(setOpenStatusDropdown)} className=" flex items-center justify-between px-4 py-2 text-sm font-medium bg-gray-50 dark:text-white dark:bg-gray-500 dark:text-gray-400 rounded-md focus:outline-none focus:bg-gray-200 dark:focus:bg-gray-600 transition duration-300 ease-in-out">
                            ...
                            <div className={`${openStatusDropdown ? "" : "hidden"} absolute z-10 mt-1 w-full bg-white dark:bg-gray-700 shadow-lg rounded-md`}>
                                <ul className="py-1">
                                    <li>
                                        <button onClick={() => handleStatusChange('Online')} className="dark:bg-gray-800 block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 w-full text-left">
