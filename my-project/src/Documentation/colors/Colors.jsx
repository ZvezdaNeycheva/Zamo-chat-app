                  ...
                  <div className="card">
                    <div className="card-body">
                      <div className="p-lg-1">
                        <h4 className="mt-0 mb-4">Color Version</h4>
                        <p className="mb-0">
                          To have color switcher enabled, Keep your html element
                          with data attribute
                          <code>data-theme-color="violet"</code> as a default
                          <br /> E.g.{" "}
                          <code>
                            {" "}
                            &lt;html data-theme-color="violet"&gt;
                          </code>{" "}
                          &amp; add HTML and JS have color change layout .
                        </p>
                      </div>
                    </div>
                  </div>
