export default function Light() {
  return (
    <>
      <meta charSet="utf-8" />
      <title>Light Version | Chatvia - Responsive TailwindCSS 5 Chat App</title>
                  ...
                  <div className="card">
                    <div className="card-body">
                      <div className="p-lg-1">
                        <h4 className="mt-0 mb-4">Light Version</h4>
                        <p className="mb-0">
                          To have light mode enabled, Keep your body element
                          with data attribute
                          <code>data-mode="light"</code> in the{" "}
                          <code> as a default </code>
                          <br /> E.g.{" "}
                          <code> &lt;body data-mode="light"&gt;</code> to have
                          Light layout.
                        </p>
                      </div>
                    </div>
